                      ...
                      builder: (context, state) {
                        ...
                        return Row(
                          children: [
                            GestureDetector(
                              onTap: () {
                                loginCubit.changeRegister(false);
                              },
                              child: Column(
                            ...
                            GestureDetector(
                              onTap: () {
                                loginCubit.changeRegister(true);
                              },
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
...
class TextFieldsCustom extends StatelessWidget {
  ...
  const TextFieldsCustom({
    ...
    required this.controller, required this.password,
  });
